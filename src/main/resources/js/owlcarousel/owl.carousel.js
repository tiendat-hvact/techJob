...
;(function ($, window, document, undefined) {
  ...
  Owl.Workers = [{
    ...
    run: function () {
      var clones = [],
          ...
          repeat = settings.loop && items.length ? settings.rewind ? view
      ...
      $.each(coordinates, $.proxy(function (index, value) {
        ...
        if (direction === 'left' && coordinate > value - pull && coordinate
          ...
          position = index + 1;
            ...
            && this.op(coordinate, '>',
                coordinates[index + 1] !== undefined ? coordinates[index + 1]
                    : value - width)) {
  ...
  Owl.prototype.coordinates = function (position) {
    ...
    if (this.settings.center) {
      ...
      coordinate += (this.width() - coordinate + (this._coordinates[newPosition]
          || 0)) / 2 * multiplier;
    } else {
    ...
    images.each($.proxy(function (i, element) {
      ...
      $(new Image()).one('load', $.proxy(function (e) {
        ...
        !this.is('pre-loading') && !this.is('initializing') && this.refresh();
          ...
          element.attr('src') || element.attr('data-src') || element.attr(
              'data-src-retina'));
    }, this));
  };
  ...
  Owl.prototype.destroy = function () {
    ...
    .attr('class', this.$element.attr('class').replace(
    ...
    if (object.type === Owl.Type.Event) {
      ...
      if (!$.event.special[object.name].owl) {
        ...
        $.event.special[object.name]._default = function (e) {
          if (_default && _default.apply && (!e.namespace
            ...
            if ((e.property && e.property.name == 'position') || e.type
              ...
              var settings = this._core.settings,
                  ...
                  position = (e.property && e.property.value !== undefined
                      ? e.property.value : this._core.current()) + i,
              ...
              while (i++ < n) {
                ...
                clones && $.each(
                    this._core.clones(this._core.relative(position)), load);
                position++;
              }
            }
          }, this)
    ...
    $elements.each($.proxy(function (index, element) {
      var $element = $(element), image,
          url = (window.devicePixelRatio > 1 && $element.attr(
              'data-src-retina')) || $element.attr('data-src') || $element.attr(
              'data-srcset');
...
;(function ($, window, document, undefined) {
  ...
  Video.prototype.thumbnail = function (target, video) {
    var tnLink,
        icon,
        path,
        dimensions = video.width && video.height ? 'width:' + video.width
...
;(function ($, window, document, undefined) {
  ...
  Navigation.prototype.initialize = function () {
    ...
    this._controls.$absolute = (settings.dotsContainer ? $(
        ...
        : $('<div>').addClass(settings.dotsClass).appendTo(
            this.$element)).addClass('disabled');
...
;(function ($, window, document, undefined) {
  ...
  var Hash = function (carousel) {
    ...
    this._handlers = {
      ...
      'prepared.owl.carousel': $.proxy(function (e) {
        if (e.namespace) {
          var hash = $(e.content).find('[data-hash]').addBack(
