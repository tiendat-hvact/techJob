...
(function (h) {
  ...
  function jb(a, b, c, d, e, f) {
    ...
    c !== k && (g = c, j = !0);
    for (; d !== e;) {
      a.hasOwnProperty(d) && (g = j ? b(g, a[d], d, a)
          : a[d], j = !0, d += f);
    }
    return g
  }
  ...
  function Ga(a, b) {
    var c = l.defaults.column, d = a.aoColumns.length,
  ...
  function la(a, b, c) {
    ...
    c !== k && null !== c && (hb(c), J(l.defaults.column, c, !0), c.mDataProp
    !== k && !c.mData && (c.mData = c.mDataProp), c.sType
    && (b._sManualType = c.sType), c.className && !c.sClass
    && (c.sClass = c.className), c.sClass && e.addClass(c.sClass), h.extend(b,
        c), F(b, c, "sWidth", "sWidthOrig"), c.iDataSort !== k
    ...
    !b.bSortable || !a && !c ? (b.sSortingClass =
        d.sSortableNone, b.sSortingClassJUI = "") : a && !c
  ...
  function Ia(a) {
    var b = a.aoColumns, c = a.aoData, d = l.ext.type.detect, e, f, g, j, i, h,
        m, q, s;
    e = 0;
  ...
  function Ka(a, b, c, d) {
    var e = [], f = b.firstChild, g, j, i = 0, h, m = a.aoColumns,
        ...
        s = function (a, b) {
          ...
          if (c === k || c === i) {
            j = m[i], h = a.innerHTML.trim(), j && j._bAttrSrc
                ? (N(j.mData._)(d, h), s(j.mData.sort, a), s(j.mData.type, a), s(
                    j.mData.filter, a)) : q ? (j._setter ||
  ...
  function Ja(a, b, c, d) {
    ...
    if (null === e.nTr) {
      ...
      for (m = a.aoColumns.length; n < m; n++) {
        ...
        g.push(e);
        if (q || (i.mRender || i.mData !== n) && (!h.isPlainObject(i.mData)
            || i.mData._ !== n + ".display")) {
          e.innerHTML = B(a, b, n,
              "display");
        }
        i.sClass && (e.className += " " + i.sClass);
        i.bVisible && !c ? j.appendChild(e) : !i.bVisible && c
            && e.parentNode.removeChild(e);
        i.fnCreatedCell && i.fnCreatedCell.call(a.oInstance, e, B(a, b, n), f,
            b, n)
      }
  ...
  function Na(a, b) {
    ...
    if (c) {
      ...
      e && (c.id =
          e);
      d.DT_RowClass && (e = d.DT_RowClass.split(" "), b.__rowc = b.__rowc ? ra(
  ...
  function mb(a) {
    var b, c, d, e, f, g = a.nTHead, j = a.nTFoot,
        i = 0 === h("th, td", g).length, n = a.oClasses, m = a.aoColumns;
    i && (e = h("<tr/>").appendTo(g));
    b = 0;
    for (c = m.length; b < c; b++) {
      f = m[b], d = h(f.nTh).addClass(f.sClass), i
      && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1
      !== f.bSortable &&
      (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Oa(a,
          f.nTh, b))), f.sTitle != d[0].innerHTML && d.html(f.sTitle), Pa(a,
          "header")(a, d, f, n);
    }
    i && fa(a.aoHeader, g);
    ...
    if (null !== j) {
      ...
      for (c = a.length; b < c; b++) {
        f = m[b], f.nTf = a[b].cell, f.sClass && h(
    ...
    if (-1 !== h.inArray(!1, b)) {
      ...
      if (0 !== i.length) {
        ...
        for (j = j ? 0 : g; j < f; j++) {
          ...
          if (0 !== e) {
            var G = d[c % e];
            q._sRowStripe != G && (h(s).removeClass(q._sRowStripe).addClass(
                G), q._sRowStripe = G)
          }
        ...
        c = f.sZeroRecords, 1 == a.iDraw && "ajax" == y(a)
            ...
            {valign: "top", colSpan: W(a), "class": a.oClasses.sRowEmpty}).html(
            c))[0];
      }
      t(a, "aoHeaderCallback", "header",
          [h(a.nTHead).children("tr")[0], Ma(a), g, n, i]);
      t(a, "aoFooterCallback", "footer",
          [h(a.nTFoot).children("tr")[0], Ma(a), g, n, i]);
      d = h(a.nTBody);
      d.children().detach();
      d.append(h(b));
    ...
    for (var f = a.sDom.split(""), g, j, i, n, m, q, k = 0; k < f.length; k++) {
      ...
      if ("<" == j) {
        ...
        if ("'" == n || '"' == n) {
          ...
          -1 != m.indexOf(".") ? (n = m.split("."), i.id = n[0].substr(1,
              n[0].length -
              1), i.className = n[1]) : "#" == m.charAt(0) ? i.id = m.substr(1,
              m.length - 1) : i.className = m;
          k += q
        }
        e.append(i);
        e = h(i)
  ...
  function ta(a, b, c) {
    ...
    a.fnServerData ? a.fnServerData.call(j, a.sAjaxSource,
        ...
        h.extend(n, {url: g || a.sAjaxSource})) : "function" === typeof g
  ...
  function wb(a) {
    ...
    for (g = 0; g < c; g++) {
      n = b[g], m = f[g], i = "function" == typeof n.mData
          ? "function" : n.mData, G.columns.push({
        data: i,
        name: n.sName,
      ...
      }), s("mDataProp_" + g, i), d.bFilter && (s("sSearch_" + g, m.sSearch), s(
          "bRegex_" + g, m.bRegex), s("bSearchable_" + g,
          n.bSearchable)), d.bSort
      && s("bSortable_" + g, n.bSortable);
    }
  ...
  function rb(a) {
    var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch,
        ...
        n = h("input", b).val(e.sSearch).attr("placeholder",
            d.sSearchPlaceholder).on(
            "keyup.DT search.DT input.DT paste.DT cut.DT", f ? Qa(i, f) : i).on(
            "mouseup", function () {
              setTimeout(function () {
                i.call(n[0])
              }, 10)
  ...
  function zb(a, b, c, d, e, f) {
    if ("" !== b) {
      for (var g = [], j = a.aiDisplay, d = Ra(b, d, e, f), e = 0; e < j.length;
          e++) {
  ...
  function yb(a, b, c, d, e, f) {
    var e = Ra(b, d, e, f), g = a.oPreviousSearch.sSearch,
        j = a.aiDisplayMaster, i, f = [];
    ...
    if (0 >= b.length) {
      ...
      if (i || c || d || g.length >
          b.length || 0 !== b.indexOf(g) || a.bSorted) {
        a.aiDisplay = j.slice();
      }
      b = a.aiDisplay;
    ...
    for (f = a.aoData.length; d < f; d++) {
      if (h =
        ...
        for (g = b.length; e < g; e++) {
          c = b[e], c.bSearchable ? (i = B(a, d, e,
                  "filter"), m[c.sType] && (i = m[c.sType](i)), null === i
              && (i = ""), "string" !== typeof i && i.toString
              && (i = i.toString()))
              : i = "", i.indexOf && -1 !== i.indexOf("&")
          && (wa.innerHTML = i, i = Zb ? wa.textContent
  ...
  function ub(a) {
    ...
    c || (a.aoDrawCallback.push({fn: Eb, sName: "information"}), d.attr("role",
  ...
  function Fb(a, b) {
    ...
    return b.replace(/_START_/g, c.call(a, d)).replace(/_END_/g,
        ...
        c.call(a, f)).replace(/_PAGE_/g, c.call(a, g ? 1 : Math.ceil(d /
  ...
  function qb(a) {
    for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu,
        e = Array.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d,
        e = h("<select/>", {
          name: c + "_length",
          "aria-controls": c,
          "class": b.sLengthSelect
        }), g = 0, j = f.length; g < j; g++) {
      e[0][g] = new Option("number" ===
  ...
  function vb(a) {
    var b = a.sPaginationType, c = l.ext.pager[b], d = "function" === typeof c,
        e = function (a) {
          P(a)
      ...
      fn: function (a) {
        if (d) {
          var b = a._iDisplayStart, i = a._iDisplayLength,
              h = a.fnRecordsDisplay(), m = -1 === i,
              b = m ? 0 : Math.ceil(b / i), i = m ? 1 : Math.ceil(h / i),
              h = c(b, i), k, m = 0;
          for (k = f.p.length; m < k; m++) {
            Pa(a, "pageButton")(a, f.p[m], m, h,
                b, i)
          }
        } else {
          c.fnUpdate(a, e)
  ...
  function Va(a, b, c) {
    ...
    (d = 0)) : "first" == b ? d = 0 : "previous" == b ? (d = 0 <= e ? d - e
        : 0, 0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last"
    == b ? d = Math.floor((f - 1) / e) * e : K(a, 0,
  ...
  function tb(a) {
    ...
    var d = c.sX, e = c.sY, f = a.oClasses, g = b.children("caption"),
        ...
        n = h(b[0].cloneNode(!1)), m = b.children("tfoot");
    m.length || (m = null);
    i = h("<div/>", {"class": f.sScrollWrapper}).append(
        h("<div/>", {"class": f.sScrollHead}).css({
          ...
          width: d ? !d ? null : w(d) : "100%"
            ...
            {"box-sizing": "content-box", width: c.sXInner || "100%"}).append(
            i.removeAttr("id").css("margin-left", 0).append(
    ...
    m && i.append(h("<div/>", {"class": f.sScrollFoot}).css({
      ...
      width: d ? !d ? null : w(d) : "100%"
        ...
        n.removeAttr("id").css("margin-left",
  ...
  function ma(a) {
    var b = a.oScroll, c = b.sX, d = b.sXInner, e = b.sY, b = b.iBarWidth,
        ...
        i = j[0].style,
        n = j.children("table"), j = a.nScrollBody, m = h(j), q = j.style,
        s = h(a.nScrollFoot).children("div"), l = s.children("table"),
        o = h(a.nTHead), p = h(a.nTable), r = p[0], t = r.style,
        u = a.nTFoot ? h(a.nTFoot) : null, U = a.oBrowser,
        V = U.bScrollOversize, $b = C(a.aoColumns, "nTh"), Q, L, R, xa, v = [],
    ...
    if (a.scrollBarVis !== L && a.scrollBarVis !== k) {
      ...
      if ("" === c) {
        t.width = "100%";
        if (V && (p.find("tbody").height() > j.offsetHeight || "scroll"
            == m.css("overflow-y"))) {
      ...
      if (p.outerWidth() < f) {
        Q = j.scrollHeight > j.offsetHeight || "scroll" == m.css("overflow-y")
            ? f + b : f;
        if (V && (j.scrollHeight > j.offsetHeight || "scroll" == m.css(
            "overflow-y"))) {
          t.width = w(Q - b);
        }
      ...
      i[e] = d ? b + "px" : "0px";
      u && (l[0].style.width = w(c), s[0].style.width = w(c), s[0].style[e] = d
          ? b + "px" : "0px");
  ...
  function I(a, b, c) {
    for (var d = 0, e = 0, f = b.length, g, j; e < f;) {
      ...
      for (j = c ? c[e].firstChild :
          null; g;) {
        1 === g.nodeType && (c ? a(g, j, d) : a(g,
            d), d++), g = g.nextSibling, j = c ? j.nextSibling : null;
      }
      e++
    }
  }
  ...
  function Ha(a) {
    var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, f = d.sX,
        g = d.sXInner, j = c.length, i = na(a, "bVisible"),
        n = h("th", a.nTHead), m = b.getAttribute("width"), k = b.parentNode,
        s = !1, l, o, p = a.oBrowser, d = p.bScrollOversize;
    (l = b.style.width) && -1 !== l.indexOf("%") && (m = l);
    for (l = 0; l < i.length; l++) {
      o = c[i[l]], null !== o.sWidth
    ...
    if (d || !s && !f && !e && j == W(a) && j == n.length) {
      ...
      for (l = 0; l < i.length; l++) {
        o = c[i[l]], n[l].style.width = null
        !== o.sWidthOrig && "" !== o.sWidthOrig ? w(o.sWidthOrig)
      ...
      if (a.aoData.length) {
        for (l = 0; l < i.length; l++) {
          s = i[l], o = c[s], h(
              Hb(a, s)).clone(!1).append(o.sContentPadding).appendTo(r);
        }
      }
      ...
      f && g ? j.width(g) : f ? (j.css("width", "auto"), j.removeAttr(
              "width"), j.width() < k.clientWidth && m && j.width(k.clientWidth))
          : e ? j.width(k.clientWidth) : m && j.width(m);
      for (l = e = 0; l < i.length; l++) {
        k = h(n[l]), g = k.outerWidth() -
  ...
  function Ib(a, b) {
    for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++) {
      c = B(a,
          f, b, "display") + "", c = c.replace(ac, ""), c = c.replace(/&nbsp;/g,
  ...
  function w(a) {
    return null === a ? "0px" : "number" == typeof a ? 0 > a ? "0px" : a + "px"
        : a.match(/\d$/) ? a + "px" : a
  }
  ...
  function Y(a) {
    ...
    for (a = 0; a < n.length; a++) {
      ...
      for (c = f.length; b < c; b++) {
        g = f[b], j = e[g].sType
            || "string", n[a]._idx === k && (n[a]._idx = h.inArray(n[a][1],
  ...
  function ob(a) {
    var b, c, d = [], e = l.ext.type.order, f = a.aoData, g = 0, j,
    ...
    if ("ssp" !=
      ...
      g === h.length ? i.sort(function (a, b) {
        ...
        for (g = 0; g < i; g++) {
          if (j = h[g], c = k[j.col], e = l[j.col], c = c
          < e ? -1 : c > e ? 1 : 0, 0 !== c) {
        ...
        for (j = 0; j < k;
            j++) {
          if (i = h[j], c = l[i.col], g = o[i.col], i = e[i.type + "-"
  ...
  function Kb(a) {
    for (var b, c, d = a.aoColumns, e = Y(a), a = a.oLanguage.oAria, f = 0,
        g = d.length; f < g; f++) {
      c = d[f];
      var j = c.asSorting;
  ...
  function Wa(a, b, c, d) {
    ...
    c && a.oFeatures.bSortMulti ? (c = h.inArray(b, C(e, "0")), -1 !== c
        ? (b = g(e[c], !0), null === b && 1 === e.length && (b = 0), null === b
            ? e.splice(c, 1) : (e[c][1] = f[b], e[c]._idx = b)) : (e.push(
            [b, f[0], 0]), e[e.length - 1]._idx = 0)) : e.length && e[0][0] == b
  ...
  function Oa(a, b, c, d) {
    var e =
        a.aoColumns[c];
    Xa(b, {}, function (b) {
      !1 !== e.bSortable && (a.oFeatures.bProcessing ? (D(a, !0), setTimeout(
          function () {
            Wa(a, c, b.shiftKey, d);
            "ssp" !== y(a) && D(a, !1)
  ...
  function ya(a) {
    var b = a.aLastSort, c = a.oClasses.sSortColumn, d = Y(a), e = a.oFeatures,
        f, g;
    if (e.bSort && e.bSortClasses) {
      e = 0;
      for (f = b.length; e < f; e++) {
        g = b[e].src, h(
            C(a.aoData, "anCells", g)).removeClass(c + (2 > e ? e + 1 : 3));
      }
      e = 0;
      for (f = d.length; e < f; e++) {
        g = d[e].src, h(
            C(a.aoData, "anCells", g)).addClass(c + (2 > e ? e + 1 : 3))
      }
    }
    a.aLastSort = d
  }
  ...
  function Jb(a,
    ...
    for (var f, g = l.ext.type.order[c.sType + "-pre"], j = 0,
    ...
    var d, e, f = a.aoColumns, b = function (b) {
      if (b && b.time) {
        ...
        if (-1 === h.inArray(!1, g) && (g = a.iStateDuration, !(0 < g && b.time
            < +new Date - 1E3 * g) && !(b.columns && f.length
            !== b.columns.length))) {
  ...
  function K(a, b, c, d) {
    ...
    if (b) {
      E.console && console.log && console.log(
          c);
    } else if (b = l.ext, b = b.sErrMode || b.errMode, a && t(a, null,
        "error", [a, d, c]), "alert" == b) {
      alert(c);
    } else {
      if ("throw" == b) {
  ...
  function ja(a, b) {
    ...
    b <= c ? c = Z(0, b) : a <= d ? (c = Z(0, c - 2), c.push(
        "ellipsis"), c.push(b - 1)) : (a >= b - 1 - d ? c = Z(b - (c - 2), b)
        : (c = Z(a - d + 2, a + d - 1), c.push("ellipsis"), c.push(
  ...
  var l = function (a) {
        ...
        this.each(function () {
          var e = {}, g = 1 < d ? Ya(e, a, !0) : a, j = 0, i,
              e = this.getAttribute("id"), n = !1, m = l.defaults, q = h(this);
          if ("table" != this.nodeName.toLowerCase()) {
            ...
            gb(g);
            Ea(g.oLanguage);
            g.aLengthMenu && !g.iDisplayLength && (g.iDisplayLength = Array.isArray(
            ...
            null !== g.iDeferLoading && (p.bDeferLoading = !0, e = Array.isArray(
                g.iDeferLoading), p._iRecordsDisplay = e ? g.iDeferLoading[0]
                : g.iDeferLoading, p._iRecordsTotal = e ? g.iDeferLoading[1]
                : g.iDeferLoading);
            var w = p.oLanguage;
            ...
            var V = p.oFeatures, e = function () {
              ...
              p.nTBody = b[0];
              b = q.children("tfoot");
              if (b.length === 0 && a.length > 0 && (p.oScroll.sX !== ""
                  || p.oScroll.sY !== "")) {
              ...
              if (g.aaData) {
                ...
                (p.bDeferLoading || y(p) == "dom") && oa(p,
                    h(p.nTBody).children("tr"));
              }
              p.aiDisplay = p.aiDisplayMaster.slice();
              p.bInitialised = true;
              n === false && ia(p)
            };
            g.bStateSave ? (V.bStateSave = !0, z(p, "aoDrawCallback", za,
                "state_save"), Lb(p, g, e)) : e()
          }
        });
        b = null;
        return this
      ...
      Pb = function (a) {
        ...
        return M(a) ? !0 : !(M(a) || "string" === typeof a) ? null : ab(
  ...
  var A = function (a, b, c) {
        a[b] !== k && (a[c] = a[b])
      }, da = /\[.*?\]$/, X = /\(\)$/, Sa = l.util.escapeRegex, wa = h("<div>")[0],
      Zb = wa.textContent !== k, ac = /<.*?>/g, Qa = l.util.throttle, Ub = [],
      x = Array.prototype, dc = function (a) {
  ...
  h.extend(r.prototype, {
    any: function () {
      ...
      var b = [];
      if (x.filter) {
        b = x.filter.call(this,
            a, this);
      } else {
        for (var c = 0, d = this.length; c < d; c++) {
          a.call(
              this, this[c], c, this) && b.push(this[c]);
        }
      }
      ...
      for (j = m.length; g < j; g++) {
        ...
        if (b ===
          ...
          f !== k && e.push(f)
        } else if (b === "column" || b === "column-rows" || b === "row" || b
            === "cell") {
          o = this[g];
          ...
          for (h = o.length; i < h; i++) {
            f = o[i];
            f = b === "cell" ? c.call(t, m[g], f.row, f.column, g, i) : c.call(
                t, m[g], f, g, i, l);
            f !== k && e.push(f)
          }
        }
  ...
  r.extend = function (a, b, c) {
    if (c.length && b && (b instanceof r || b.__dt_wrapper)) {
      ...
      for (e = c.length; d < e; d++) {
        f = c[d];
        b[f.name] =
            f.type === "function" ? g(a, f.val, f) : f.type === "object" ? {}
                : f.val;
  ...
  r.register = o = function (a, b) {
    if (Array.isArray(a)) {
      ...
      for (var e = a.split("."), f = Ub, g, j, c = 0,
          d = e.length; c < d; c++) {
  ...
  r.registerPlural = u = function (a, b, c) {
    ...
    r.register(b, function () {
      ...
      return a === this ? this : a instanceof r ? a.length ? Array.isArray(a[0])
          ? new r(a.context, a[0]) : a[0] : k : a
    })
  };
  var Vb = function (a, b) {
    if (Array.isArray(a)) {
  ...
  var bb = function (a, b, c, d, e) {
    ...
    for (h = b.length; i < h; i++) {
      ...
      for (l = j.length; m < l; m++) {
        (g = c(
            typeof j[m] === "string" ? j[m].trim() : j[m])) && g.length
        && (f = f.concat(g))
      }
    }
    a = v.selector[a];
  ...
  u("rows().ids()", "row().id()", function (a) {
    for (var b = [], c = this.context, d = 0, e = c.length; d < e;
        d++) {
  ...
  o("rows.add()", function (a) {
    var b = this.iterator("table", function (b) {
      ...
      for (g =
          a.length; f < g; f++) {
        c = a[f];
        c.nodeName && c.nodeName.toUpperCase() === "TR" ? h.push(oa(b, c)[0])
            : h.push(O(b, c))
      }
      return h
    }, 1), c = this.rows(-1);
  ...
  o("row.add()", function (a) {
    ...
    var b = this.iterator("table", function (b) {
      return a.nodeName && a.nodeName.toUpperCase() === "TR" ? oa(b, a)[0] : O(
          b, a)
    });
    return this.row(b[0])
  });
      ...
      if (d._details) {
        ...
        if (C(g, "_details").length > 0) {
          ...
          f.on("column-visibility.dt.DT_details", function (a, b) {
            if (e === b) {
              for (var c, d = W(b), f = 0, h = g.length; f < h;
                  f++) {
                c = g[f];
                c._details &&
    ...
    if (a === true) {
      ...
      var d = c[0], c = c[0].aoData[this[0]], e = [], f = function (a, b) {
        if (Array.isArray(a) || a instanceof h) {
          for (var c = 0, k = a.length;
              c < k; c++) {
            f(a[c],
                b);
          }
        } else if (a.nodeName && a.nodeName.toLowerCase()
            === "tr") {
          e.push(a);
        } else {
  ...
  o("row().child.isShown()", function () {
    var a = this.context;
    return a.length && this.length ? a[0].aoData[this[0]]._detailsShow || false
        : false
  });
  ...
  o("cells()", function (a, b, c) {
    ...
    if (b === null || b === k) {
      return this.iterator("table", function (b) {
        var d = a, e = cb(c), f = b.aoData, g = Da(b, e),
            i = Sb(ka(f, g, "anCells")), j = h(Tb([], i)), l,
    ...
    var d = c ? {page: c.page, order: c.order, search: c.search} : {},
        e = this.columns(b, d), f = this.rows(a, d), g, j, i, l,
  ...
  o("order()", function (a, b) {
    ...
    typeof a === "number" ?
        a = [[a, b]] : a.length && !Array.isArray(a[0])
  ...
  o("search()", function (a, b, c, d) {
    var e = this.context;
    return a === k ? e.length !== 0 ? e[0].oPreviousSearch.sSearch : k
  ...
  l.versionCheck = l.fnVersionCheck = function (a) {
    for (var b = l.version.split("."), a = a.split("."), c, d, e = 0,
        f = a.length; e < f; e++) {
      c = parseInt(b[e], 10) || 0;
      d = parseInt(a[e], 10) || 0;
      if (c !== d) {
  ...
  o("destroy()", function (a) {
    ...
    return this.iterator("table", function (b) {
      var c = b.nTableWrapper.parentNode, d = b.oClasses, e = b.nTable,
          ...
          k = h(b.nTableWrapper), m = h.map(b.aoData, function (a) {
            return a.nTr
          }), o;
      b.bDestroying = true;
  ...
  l.models.oSettings = {
    ...
    fnRecordsTotal: function () {
      return y(this) == "ssp" ? this._iRecordsTotal * 1
          : this.aiDisplayMaster.length
    },
    fnRecordsDisplay: function () {
      return y(this) == "ssp" ? this._iRecordsDisplay * 1
          : this.aiDisplay.length
    },
    fnDisplayEnd: function () {
      var a = this._iDisplayLength,
          b = this._iDisplayStart, c = b + a, d = this.aiDisplay.length,
          e = this.oFeatures, f = e.bPaginate;
      return e.bServerSide ? f === false || a === -1 ? b + d : Math.min(b + a,
          this._iRecordsDisplay) : !f || c > d || a === -1 ? d : c
    },
    oInstance: null,
    sInstance: null,
    iTabIndex: 0,
    ...
    pageButton: {
      _: function (a, b, c, d, e, f) {
        var g = a.oClasses, j = a.oLanguage.oPaginate,
            i = a.oLanguage.oAria.paginate || {}, l, m, o = 0,
            s = function (b, d) {
        ...
        h(a.nTable).on("order.dt.DT", function (e, f, g, h) {
          if (a === f) {
            ...
            b.find("span." + d.sSortIcon).removeClass(
                ...
                h[e] == "asc" ? d.sSortJUIAsc : h[e] == "desc" ? d.sSortJUIDesc
                    : c.sSortingClassJUI)
          }
        })
      }
