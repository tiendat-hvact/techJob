...
public class CommonController {
    ...
    public String loginAccount(HttpServletResponse response, @ModelAttribute(name = "user") LoginRequest account) {
        int accountId;
        Boolean verify;
        ...
        if (resultLogin != null && !resultLogin.isEmpty()) {
            ...
            String role = resultLogin.get("role").toString();
            if ("admin".equals(type) && !"ADMIN".equals(role)) {
              return "redirect:/techJob/login?text=not-admin";
            }
